...
Route::middleware(['localeSessionRedirect', 'localizationRedirect', 'localeViewPath'])->prefix(LaravelLocalization::setLocale())->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::prefix('panel')->group(function () {
            ...
            Route::get('foods/orders', [\App\Http\Controllers\Panel\FoodController::class, 'order'])->name('foods.order');
            Route::patch('foods/orders', [\App\Http\Controllers\Panel\FoodController::class, 'orderUpdate'])->name('foods.order.update');
